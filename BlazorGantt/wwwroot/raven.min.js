    ...
    return function a(b, c, d) {
        ...
        4: [function (a, b, c) {
            (function (c) {
                ...
                function t(a) {
                    for (var b, c = 5, d = 80, e = [], f = 0, g = 0, h = " > ", i = h.length; a && f++ < c && (b = u(a),
                ...
                e.prototype = {
                    ...
                    config: function (a, b) {
                        var c = this;
                        if (c.e)
                            return this.w("error", "Error: Raven has already been configured"),
                                c;
                        if (!a)
                            return c;
                        var d = c.i;
                        ...
                        var e = {
                            ...
                            , f = d.autoBreadcrumbs;
                        return "[object Object]" === {}.toString.call(f) ? f = m(e, f) : f !== !1 && (f = e),
                            d.autoBreadcrumbs = f,
                            w.collectWindowErrors = !!d.collectWindowErrors,
                            c
                    },
                    install: function () {
                        var a = this;
                        return a.isSetup() && !a.k && (w.report.subscribe(function () {
                            ...
                            a.y(),
                            a.i.autoBreadcrumbs && a.z(),
                            a.A(),
                            a.k = !0),
                            Error.stackTraceLimit = a.i.stackTraceLimit,
                            this
                    },
                    setDSN: function (a) {
                        var b = this
                        ...
                        b.C = a,
                            b.f = c.user,
                            b.D = c.pass && c.pass.substr(1),
                            b.g = c.path.substr(d + 1),
                            b.e = b.E(c),
                            b.F = b.e + "/" + e + "api/" + b.g + "/store/",
                            this.v()
                    },
                    ...
                    wrap: function (a, b, c) {
                        function d() {
                            var d = []
                                , f = arguments.length
                                , h = !a || a && a.deep !== !1;
                            for (c && g(c) && c.apply(this, arguments); f--;)
                                d[f] = h ? e.wrap(a, arguments[f]) : arguments[f];
                            try {
                    ...
                    captureException: function (a, b) {
                        if (!k(a))
                            return this.captureMessage(a, m({
                                trimHeadFrames: 1,
                                stacktrace: !0
                            }, b));
                        this.c = a;
                    ...
                    setExtraContext: function (a) {
                        return this.O("extra", a),
                            this
                    },
                    setTagsContext: function (a) {
                        return this.O("tags", a),
                            this
                    },
                    ...
                    isSetup: function () {
                        return !!this.a && (!!this.e || (this.ravenNotConfiguredError || (this.ravenNotConfiguredError = !0,
                            this.w("error", "Error: Raven has not been configured.")),
                            !1))
                    },
                    afterLoad: function () {
                        var a = C.RavenConfig;
                    ...
                    showReportDialog: function (a) {
                        if (D) {
                            ...
                            if (!b)
                                throw new x("Missing eventId");
                            var c = a.dsn || this.C;
                            if (!c)
                                throw new x("Missing DSN");
                    ...
                    P: function (a, b) {
                        ...
                        if (this.b) {
                            b = b || {},
                                ...
                                D.createEvent ? (c = D.createEvent("HTMLEvents"),
                                    c.initEvent(a, !0, !0)) : (c = D.createEventObject(),
                                        c.eventType = a);
                            for (d in b)
                                o(b, d) && (c[d] = b[d]);
                            if (D.createEvent)
                    ...
                    y: function () {
                        ...
                        function b(a) {
                            ...
                            b && b.hasOwnProperty && b.hasOwnProperty("addEventListener") && (v(b, "addEventListener", function (b) {
                                return function (d, f, g, h) {
                                    ...
                                    var j, k, l;
                                    return e && e.dom && ("EventTarget" === a || "Node" === a) && (k = c.Q("click"),
                                        l = c.S(),
                                        j = function (a) {
                                            if (a)
                                                return "click" === a.type ? k(a) : "keypress" === a.type ? l(a) : void 0
                                        }
                                    ),
                                        b.call(this, d, c.wrap(f, void 0, j), g, h)
                                }
                            }, d),
                                v(b, "removeEventListener", function (a) {
                        ...
                        v(C, "setTimeout", a, d),
                            v(C, "setInterval", a, d),
                            C.requestAnimationFrame && v(C, "requestAnimationFrame", function (a) {
                                return function (b) {
                                    return a(c.wrap(b))
                                }
                            }, d);
                        for (var f = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"], h = 0; h < f.length; h++)
                            b(f[h]);
                        var i = C.jQuery || C.$;
                    ...
                    z: function () {
                        ...
                        if (c.xhr && "XMLHttpRequest" in C) {
                            ...
                            v(e, "open", function (a) {
                                return function (c, d) {
                                    return h(d) && d.indexOf(b.f) === -1 && (this.U = {
                                        method: c,
                                        url: d,
                                        status_code: null
                                    }),
                                ...
                                v(e, "send", function (c) {
                                    return function (d) {
                                        ...
                                        for (var f = this, h = ["onload", "onerror", "onprogress"], i = 0; i < h.length; i++)
                                            a(h[i], f);
                        ...
                        c.xhr && "fetch" in C && v(C, "fetch", function (a) {
                            ...
                            c.dom && this.b && (D.addEventListener ? (D.addEventListener("click", b.Q("click"), !1),
                                D.addEventListener("keypress", b.S(), !1)) : (D.attachEvent("onclick", b.Q("click")),
                                    D.attachEvent("onkeypress", b.S())));
                        var f = C.chrome
                    ...
                    B: function (a) {
                        ...
                        if (c.pass && !this.i.allowSecretKey)
                            throw new x("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key");
                        return c
                    },
                    E: function (a) {
                    ...
                    x: function () {
                        this.j || this.L.apply(this, arguments)
                    },
                    L: function (a, b) {
                        var c = this.M(a, b);
                        this.P("handle", {
                    ...
                    Y: function () {
                        if (this.b && D.location && D.location.href) {
                            ...
                            return a.url = D.location.href,
                                D.referrer && (a.headers.Referer = D.referrer),
                                a
                        }
                    },
                    v: function () {
                    ...
                    N: function (a) {
                        ...
                        if (e && (c.request = e),
                            ...
                            a = m(c, a),
                            a.tags = m(m({}, this.h.tags), a.tags),
                            a.extra = m(m({}, this.h.extra), a.extra),
                            ...
                            g(b.dataCallback) && (a = b.dataCallback(a) || a),
                            a && !j(a) && (!g(b.shouldSendCallback) || b.shouldSendCallback(a)))
                            return this._() ? void this.w("warn", "Raven dropped error due to backoff: ", a) : void this.ba(a)
                    },
                    ca: function () {
                        return s()
                    },
                    ba: function (a, b) {
                        var c = this
                            , d = this.i;
                        if (this.isSetup()) {
                            this.d = a.event_id || (a.event_id = this.ca()),
                                a = this.X(a),
                                this.w("debug", "Raven about to send:", a);
                            var e = {
                                sentry_version: "7",
                            ...
                            (d.transport || this.da).call(this, {
                                ...
                                onError: function (d) {
                                    c.w("error", "Raven transport failed to send: ", d),
                                        d.request && c.aa(d.request),
                                        c.P("failure", {
                                            data: a,
                                            src: g
                                        }),
                    ...
                    da: function (a) {
                        function b() {
                            if (200 === c.status)
                                ...
                                var b = new Error("Sentry error code: " + c.status);
                                b.request = c,
                                    a.onError(b)
                            }
                        }
            ...
            (function (a) {
                ...
                d.report = function () {
                    ...
                    function k(a, b, e, f, i) {
                        var k = null;
                        if (u)
                            d.computeStackTrace.augmentStackTraceWithInitialElement(u, b, e, a),
                                n();
                        else if (i)
                            k = d.computeStackTrace(i),
                                j(k, !0);
                        else {
                            var l, m = {
                                url: b,
                    ...
                    d.computeStackTrace = function () {
                        function a(a) {
                            if ("undefined" != typeof a.stack && a.stack) {
                                for (var b, d, e = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|<anonymous>).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, f = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|resource|\[native).*?)(?::(\d+))?(?::(\d+))?\s*$/i, h = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, i = a.stack.split("\n"), j = [], k = (/^(.*) is undefined$/.exec(a.message),
                                    0), l = i.length; k < l; ++k) {
                                    if (b = e.exec(i[k])) {
                            ...
                            for (var i, j, k = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, l = [], m = {}, n = !1, o = e.caller; o && !n; o = o.caller)
                                if (o !== f && o !== d.report) {
                                    if (j = {
                                        ...
                                        o.name ? j.func = o.name : (i = k.exec(o.toString())) && (j.func = i[1]),
